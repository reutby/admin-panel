  ...
  <div>
    ...
    <table>
      ...
      <tr v-for="category in categories" :key="category._id">
        ...
        <td>{{ category.path }}</td>
        <td>
          <i v-if="!category.homePage" @click.prevent="askBeforeRemove(category)" class="el-icon-delete" />
        </td>
      </tr>
      </tbody>
    </table>
...
<script>
  ...
  import CreateHomePage from '@/modules/categories/components/CreateHomePage'
